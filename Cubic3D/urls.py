...
urlpatterns = [
    ...
    url(r'^gettingstarted/quoteupload',app.views.def_quote, name='def_quote'),
    url(r'^gettingstarted/review_n_info',app.views.review_n_info, name='review_n_info'),
    url(r'^gettingstarted/quote_review',app.views.quote_review, name='quote_review'),
    url(r'^cancelprint',app.views.cancel, name='cancel'),
    url(r'^quotefinish',app.views.delquote, name='delquote'),
